...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='DoctorId',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='CMSapp.doctor'),
        ),
        migrations.CreateModel(
            name='LabTest',
            fields=[
                ...
                ('IsActive', models.BooleanField(default=True)),
                ('LabTestCategoryId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='CMSapp.labtestcategory')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('IsActive', models.BooleanField(default=True)),
                ('MedicineCategoryId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='CMSapp.medicinecategory')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('IsActive', models.BooleanField(default=True)),
                ('MembershipId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='CMSapp.membership')),
            ],
        ),
        migrations.AddField(
            model_name='appointment',
            name='PatientId',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='CMSapp.patient'),
        ),
        migrations.AddField(
            model_name='doctor',
            name='SpecializationId',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='CMSapp.specialization'),
        ),
        migrations.CreateModel(
            name='Staff',
            fields=[
                ...
                ('IsActive', models.BooleanField(default=True)),
                ('RoleId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='CMSapp.role')),
            ],
        ),
        migrations.AddField(
            model_name='doctor',
            name='StaffId',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='CMSapp.staff'),
        ),
    ]
